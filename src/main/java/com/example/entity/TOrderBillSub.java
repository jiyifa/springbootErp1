...
public class TOrderBillSub {
  ...
  private java.sql.Date suggestpurdate;
  ...
  public java.sql.Date getSuggestpurdate() {
    return suggestpurdate;
  }

  public void setSuggestpurdate(java.sql.Date suggestpurdate) {
