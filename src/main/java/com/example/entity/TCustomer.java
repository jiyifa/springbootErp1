...
public class TCustomer {
  ...
  private java.sql.Date buildupdate;
  private java.sql.Date lastvisitdate;
  private java.sql.Date bookvisitdate;
  private java.sql.Date invaliddate;
  private String amountquota;
  private String remainquata;
  private String recrway;
  private String receivables;
  private String dayofclose;
  ...
  public java.sql.Date getBuildupdate() {
    return buildupdate;
  }

  public void setBuildupdate(java.sql.Date buildupdate) {
    this.buildupdate = buildupdate;
  }


  public java.sql.Date getLastvisitdate() {
    return lastvisitdate;
  }

  public void setLastvisitdate(java.sql.Date lastvisitdate) {
    this.lastvisitdate = lastvisitdate;
  }


  public java.sql.Date getBookvisitdate() {
    return bookvisitdate;
  }

  public void setBookvisitdate(java.sql.Date bookvisitdate) {
    this.bookvisitdate = bookvisitdate;
  }
  ...
  public String getRemainquata() {
    return remainquata;
  }

  public void setRemainquata(String remainquata) {
    this.remainquata = remainquata;
  }


  public String getRecrway() {
    return recrway;
  }

  public void setRecrway(String recrway) {
    this.recrway = recrway;
  }
  ...
  public String getDayofclose() {
    return dayofclose;
  }

  public void setDayofclose(String dayofclose) {
  ...
  public String getNotinvquota() {
    return notinvquota;
  }

  public void setNotinvquota(String notinvquota) {
    this.notinvquota = notinvquota;
  }
