...
public class TProdMain {
  ...
  private java.sql.Date effectdateused;
  private java.sql.Date validateused;
  private String defvaliday;
  private String proddesc;
  private String safeqty;
  private String majonrsupplierid;
  private java.sql.Date boutstockday;
  private java.sql.Date binstockday;
  ...
  public java.sql.Date getEffectdateused() {
    return effectdateused;
  }

  public void setEffectdateused(java.sql.Date effectdateused) {
    this.effectdateused = effectdateused;
  }


  public java.sql.Date getValidateused() {
    return validateused;
  }

  public void setValidateused(java.sql.Date validateused) {
    this.validateused = validateused;
  }


  public String getDefvaliday() {
    return defvaliday;
  }

  public void setDefvaliday(String defvaliday) {
    this.defvaliday = defvaliday;
  }
  ...
  public String getMajonrsupplierid() {
    return majonrsupplierid;
  }

  public void setMajonrsupplierid(String majonrsupplierid) {
    this.majonrsupplierid = majonrsupplierid;
  }


  public java.sql.Date getBoutstockday() {
    return boutstockday;
  }

  public void setBoutstockday(java.sql.Date boutstockday) {
    this.boutstockday = boutstockday;
  }


  public java.sql.Date getBinstockday() {
    return binstockday;
  }

  public void setBinstockday(java.sql.Date binstockday) {
